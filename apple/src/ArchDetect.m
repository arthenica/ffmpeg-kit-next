...
#define FFMPEG_KIT_STR_EXPAND(x) #x
#define FFMPEG_KIT_STR(x)        FFMPEG_KIT_STR_EXPAND(x)
    return [NSString stringWithUTF8String:FFMPEG_KIT_STR(FFMPEG_KIT_MIN_SDK)];
#undef FFMPEG_KIT_STR_EXPAND
#undef FFMPEG_KIT_STR
#else
    return @"";
#endif
}
