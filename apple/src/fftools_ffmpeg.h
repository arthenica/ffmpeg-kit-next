 ...
 * Derived from FFmpeg source file fftools/ffmpeg.h.
 *
 ...
 * It is derived from FFmpeg's fftools/ffmpeg.h at tag n7.1.5.
 *
 ...
 * SPECIFIER_OPT_FMT declarations migrated to ffmpeg_mux.h
 ...
 * - dropped signatures of ffmpeg_opt.c methods called by both ffmpeg and
 * ffprobe
 *
 * 06.2020
 * --------------------------------------------------------
 ...
 * by multiple threads, signatures of ffmpeg_opt.c methods called by both ffmpeg
 * and ffprobe added)
 *
 * 03.2019
 * --------------------------------------------------------
...
extern __thread Decoder     **decoders;
extern __thread int        nb_decoders;
...
extern __thread const OptionDef *options;
void ffmpeg_options_init(void);
void ffmpeg_options_uninit(void);
extern __thread HWDevice *filter_hw_device;

extern __thread atomic_uint *nb_output_dumped_ref;
#define nb_output_dumped (*nb_output_dumped_ref)
...
extern __thread FILE *vstats_file;
