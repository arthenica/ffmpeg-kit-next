 ...
 * It is derived from FFmpeg's fftools/opt_common.c at tag n7.1.5.
 *
...
{
    print_program_info (SHOW_COPYRIGHT, AV_LOG_STDERR);
    print_all_libs_info(SHOW_VERSION, AV_LOG_STDERR);
...
{
    print_buildconf      (INDENT|0, AV_LOG_STDERR);
