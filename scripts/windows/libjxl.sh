...
if [[ -d "${LIB_INSTALL_PREFIX}/lib/pkgconfig" ]]; then
  copy_and_update_path "${LIB_INSTALL_PREFIX}/lib/pkgconfig/"*.pc "${INSTALL_PKG_CONFIG_DIR}" || return 1
elif [[ -d "${LIB_INSTALL_PREFIX}/lib64/pkgconfig" ]]; then
  copy_and_update_path "${LIB_INSTALL_PREFIX}/lib64/pkgconfig/"*.pc "${INSTALL_PKG_CONFIG_DIR}" || return 1
else
  return 1
fi
