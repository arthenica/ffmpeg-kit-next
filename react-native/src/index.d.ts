declare module 'ffmpeg-kit-react-native' {
  ...
  export class FFmpegKitInputBuffer {
    ...
    static fromBase64(base64Data: string, extension?: string): Promise<FFmpegKitInputBuffer>;
  ...
  export class FFmpegKitOutputBuffer {
    ...
    static create(extension?: string, initialCapacity?: number, maxCapacity?: number): Promise<FFmpegKitOutputBuffer>;
  ...
  export class FFmpegKitStreamInput {
    ...
    static create(extension?: string, capacity?: number): Promise<FFmpegKitStreamInput>;

    getUrl(): string;

    write(base64Data: string, timeoutMs?: number): Promise<number>;
  ...
  export class FFmpegKitStreamOutput {
    ...
    static create(extension?: string, capacity?: number): Promise<FFmpegKitStreamOutput>;
