 ...
 * Derived from FFmpeg source file fftools/ffmpeg_mux_init.c.
 *
 ...
 *   cancellation and thread/session-local execution, and parentheses added around
 *   subtitle descriptor matching for -Werror builds
 *
 * 06.2026
 * --------------------------------------------------------
