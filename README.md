...
`Objective-C` API, `Flutter` library comes with a `Dart` API, `Linux` and `Windows` libraries have a `C++` API, `React Native` and `Web`
...
<tr>
<td align="center"><sup>windows system libraries</sup></td>
<td align="center"><sup>zlib</sup></td>
</tr>
</tbody>
</table>
