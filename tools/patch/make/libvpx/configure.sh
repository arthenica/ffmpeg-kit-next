...
EOF
  ...
  case ${toolchain} in
    arm*-darwin*)
      # FFMPEG-KIT: SDK/arch/min-version are supplied via --extra-cflags; injection disabled
    ...
    x86*-darwin*)
      ...
      # FFMPEG-KIT: isysroot is supplied via --extra-cflags; injection disabled
  ...
  case ${toolchain} in
    ...
    *-darwin19-*)
      ...
      ;;
    *-darwin2[0-5]-*)
      # FFMPEG-KIT: arch is supplied via --extra-cflags; injection disabled
      # add_cflags  "-arch ${toolchain%%-*}"
      # add_ldflags "-arch ${toolchain%%-*}"
      ;;
    *-iphonesimulator-*)
      # FFMPEG-KIT: SDK/min-version are supplied via --extra-cflags; injection disabled
      ...
      case ${tgt_os} in
        ...
        darwin)
          if ! enabled external_build; then
            ...
            # FFMPEG-KIT: arch/isysroot/min-version are supplied via --extra-cflags; injection disabled
