 ...
 * It is derived from FFmpeg's fftools/cmdutils.c at tag n8.1.2.
 *
 ...
 * them between in-process runs, consistent with the other cmdutils globals. */
__thread char** win32_argv_utf8 = NULL;
__thread int win32_argc = 0;
