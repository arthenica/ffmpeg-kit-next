...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_H
...
class MediaInformation {
  ...
  private:
    ...
    std::shared_ptr<std::vector<std::shared_ptr<ffmpegkit::internal::StreamInformation>>>
        _streams;
    std::shared_ptr<std::vector<std::shared_ptr<ffmpegkit::internal::Chapter>>> _chapters;
};

} // namespace internal
} // namespace ffmpegkit

#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_H
