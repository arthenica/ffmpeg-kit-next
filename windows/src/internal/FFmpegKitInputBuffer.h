...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_INPUT_BUFFER_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_INPUT_BUFFER_H
...
class FFmpegKitInputBuffer {
  public:
    static std::shared_ptr<ffmpegkit::internal::FFmpegKitInputBuffer>
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_INPUT_BUFFER_H
