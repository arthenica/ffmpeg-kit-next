...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_ABSTRACT_SESSION_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_ABSTRACT_SESSION_H
...
class AbstractSession : public Session,
  ...
  public:
     ...
     */
    ffmpegkit::internal::LogCallback getLogCallback() const override;
     ...
     */
    ffmpegkit::internal::SessionState getState() const override;
     ...
     */
    std::shared_ptr<ffmpegkit::internal::ReturnCode> getReturnCode() const override;
     ...
     * @param log log entry
     */
    void addLog(const std::shared_ptr<ffmpegkit::internal::Log> log) override;
     ...
     */
    void
    complete(const std::shared_ptr<ffmpegkit::internal::ReturnCode> returnCode) override;
  ...
  private:
    ...
    ffmpegkit::internal::LogCallback _logCallback;
    ...
    std::shared_ptr<std::list<std::shared_ptr<ffmpegkit::internal::Log>>> _logs;
    SessionState _state;
    std::shared_ptr<ffmpegkit::internal::ReturnCode> _returnCode;
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_ABSTRACT_SESSION_H
