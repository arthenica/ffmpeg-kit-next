...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFPROBE_SESSION_COMPLETE_CALLBACK_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFPROBE_SESSION_COMPLETE_CALLBACK_H
...
typedef std::function<void(
    const std::shared_ptr<ffmpegkit::internal::FFprobeSession> session)>
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFPROBE_SESSION_COMPLETE_CALLBACK_H
