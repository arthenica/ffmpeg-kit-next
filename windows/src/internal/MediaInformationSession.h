...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_SESSION_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_SESSION_H
...
class MediaInformationSession : public AbstractSession {
  public:
     ...
     */
    std::shared_ptr<ffmpegkit::internal::MediaInformation> getMediaInformation();
     ...
     */
    ffmpegkit::internal::MediaInformationSessionCompleteCallback getCompleteCallback();
  ...
  private:
    ...
    ffmpegkit::internal::MediaInformationSessionCompleteCallback _completeCallback;
    std::shared_ptr<ffmpegkit::internal::MediaInformation> _mediaInformation;
};

} // namespace internal
} // namespace ffmpegkit

#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_SESSION_H
