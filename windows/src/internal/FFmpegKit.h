...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_H
...
class FFmpegKit {
  public:
     ...
     * you want to be notified about the result.
     *
     * @param arguments           FFmpeg command options/arguments as string
     * list
     * @param completeCallback    callback that will be called when the
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_H
