...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_PARSER_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_PARSER_H
...
class MediaInformationJsonParser {
  public:
     ...
     * occurs
     */
    static std::shared_ptr<ffmpegkit::internal::MediaInformation>
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_MEDIA_INFORMATION_PARSER_H
