...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFMPEG_SESSION_COMPLETE_CALLBACK_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFMPEG_SESSION_COMPLETE_CALLBACK_H
...
typedef std::function<void(
    const std::shared_ptr<ffmpegkit::internal::FFmpegSession> session)>
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFMPEG_SESSION_COMPLETE_CALLBACK_H
