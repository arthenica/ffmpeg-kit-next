...
ffmpegkit::internal::MediaInformationJsonParser::from(
...
ffmpegkit::internal::MediaInformationJsonParser::fromWithError(
    ...
    if (document->HasParseError()) {
        ...
        std::shared_ptr<
            std::vector<std::shared_ptr<ffmpegkit::internal::StreamInformation>>>
            streams = std::make_shared<
                std::vector<std::shared_ptr<ffmpegkit::internal::StreamInformation>>>();
        std::shared_ptr<std::vector<std::shared_ptr<ffmpegkit::internal::Chapter>>>
            chapters = std::make_shared<
                std::vector<std::shared_ptr<ffmpegkit::internal::Chapter>>>();
        ...
        if (document->HasMember(MediaInformationJsonParserKeyStreams)) {
            ...
            if (streamArray.IsArray()) {
                for (rapidjson::SizeType i = 0; i < streamArray.Size(); i++) {
                    streams->push_back(
                        std::make_shared<ffmpegkit::internal::StreamInformation>(
        ...
        if (document->HasMember(MediaInformationJsonParserKeyChapters)) {
            ...
            if (chapterArray.IsArray()) {
                for (rapidjson::SizeType i = 0; i < chapterArray.Size(); i++) {
                    chapters->push_back(std::make_shared<ffmpegkit::internal::Chapter>(
                        std::make_shared<ffmpegkit::json::Value>(
        ...
        return std::make_shared<ffmpegkit::internal::MediaInformation>(
