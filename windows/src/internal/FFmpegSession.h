...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFMPEG_SESSION_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFMPEG_SESSION_H
...
class FFmpegSession : public AbstractSession {
  public:
     ...
     */
    static std::shared_ptr<ffmpegkit::internal::FFmpegSession>
    ...
    create(const std::list<std::string> &arguments,
           ...
           ffmpegkit::internal::LogCallback logCallback,
           ffmpegkit::internal::StatisticsCallback statisticsCallback,
           ffmpegkit::internal::LogRedirectionStrategy logRedirectionStrategy);
     ...
     */
    ffmpegkit::internal::StatisticsCallback getStatisticsCallback();
     ...
     */
    ffmpegkit::internal::FFmpegSessionCompleteCallback getCompleteCallback();
     ...
     *
     * @return the last received statistics entry or nullptr if there are not
     * any statistics entries received
     */
    std::shared_ptr<ffmpegkit::internal::Statistics> getLastReceivedStatistics();
     ...
     */
    void addStatistics(const std::shared_ptr<ffmpegkit::internal::Statistics> statistics);
  ...
  private:
    ...
    ffmpegkit::internal::StatisticsCallback _statisticsCallback;
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFMPEG_SESSION_H
