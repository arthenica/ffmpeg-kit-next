...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_CHAPTER_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_CHAPTER_H
...
class Chapter {
  ...
  private:
    std::shared_ptr<ffmpegkit::json::Value> _chapterValue;
};

} // namespace internal
} // namespace ffmpegkit

#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_CHAPTER_H
