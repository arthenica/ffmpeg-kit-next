...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_OUTPUT_BUFFER_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_OUTPUT_BUFFER_H
...
class FFmpegKitOutputBuffer {
  public:
    static std::shared_ptr<ffmpegkit::internal::FFmpegKitOutputBuffer>
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_OUTPUT_BUFFER_H
