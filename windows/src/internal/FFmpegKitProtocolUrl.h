...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_PROTOCOL_URL_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_PROTOCOL_URL_H
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_PROTOCOL_URL_H
