...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFPROBE_SESSION_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFPROBE_SESSION_H
...
class FFprobeSession : public AbstractSession {
  public:
     ...
     */
    ffmpegkit::internal::FFprobeSessionCompleteCallback getCompleteCallback();
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_FFPROBE_SESSION_H
