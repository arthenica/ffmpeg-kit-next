...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_LOG_REDIRECTION_STRATEGY_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_LOG_REDIRECTION_STRATEGY_H
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_LOG_REDIRECTION_STRATEGY_H
