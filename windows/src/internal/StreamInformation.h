...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_STREAM_INFORMATION_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_STREAM_INFORMATION_H
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_STREAM_INFORMATION_H
