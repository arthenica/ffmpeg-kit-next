...
#ifndef FFMPEG_KIT_INTERNAL_FFMPEG_KIT_SESSION_DELETE_LISTENER_H
#define FFMPEG_KIT_INTERNAL_FFMPEG_KIT_SESSION_DELETE_LISTENER_H
...
#endif // FFMPEG_KIT_INTERNAL_FFMPEG_KIT_SESSION_DELETE_LISTENER_H
