 ...
 * Derived from FFmpeg source file fftools/ffmpeg_demux.c.
 *
 ...
 * 07.2026
 * --------------------------------------------------------
 * - FFmpeg 8.1.2 changes migrated, platform fftools layout updates applied,
 *   FFmpegKitNext integration updates preserved including wrapper API, callbacks,
 *   cancellation and thread/session-local execution, and assignment condition
 *   parenthesized for -Werror builds
 *
 * 06.2026
 * --------------------------------------------------------
